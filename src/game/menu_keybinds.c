...
static void load_static_keybind_texts(sfText **texts, sfVector2f resize)
{
    ...
    texts[4] = init_text("Courir :",
        (sfVector2f){ resize.x + 90, resize.y + 390 }, 30, color);
    texts[5] = init_text("Inventaire :",
        (sfVector2f){ resize.x + 90, resize.y + 430 }, 30, color);
    texts[6] = init_text("Interragir :",
        (sfVector2f){ resize.x + 90, resize.y + 470 }, 30, color);
    texts[7] = init_text("Competences :",
        (sfVector2f){ resize.x + 90, resize.y + 510 }, 30, color);
}
...
static void load_dynamic_keybind_texts(sfText **texts, sfVector2f resize)
{
    ...
    texts[12] = init_text("",
        (sfVector2f){ resize.x + 205, resize.y + 390 }, 30, sfWhite);
    texts[13] = init_text("",
        (sfVector2f){ resize.x + 260, resize.y + 430 }, 30, sfWhite);
    texts[14] = init_text("",
        (sfVector2f){ resize.x + 260, resize.y + 470 }, 30, sfWhite);
    texts[15] = init_text("",
        (sfVector2f){ resize.x + 290, resize.y + 510 }, 30, sfWhite);
}
...
void update_dynamic_texts(game_t *game_info, sfText **texts)
{
    ...
    key[0] = game_info->keybinds->sprint + 'A';
    sfText_setString(texts[12], key);
    key[0] = game_info->keybinds->open_inventory + 'A';
    sfText_setString(texts[13], key);
    key[0] = game_info->keybinds->interact + 'A';
    sfText_setString(texts[14], key);
    key[0] = game_info->keybinds->skills + 'A';
    sfText_setString(texts[15], key);
    free(key);
}

sfText **load_texts_elements(game_t *game_info, sfVector2f resize)
{
    sfText **texts = malloc(sizeof(sfText *) * 17);
