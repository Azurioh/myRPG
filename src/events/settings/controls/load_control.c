...
static void load_control_texts(myrpg_t *myrpg, int text_size)
{
    ...
    texts[0] = init_text("Modification des touches",
        ...
        text_size * SETTINGS->scaling, sfWhite);
    texts[1] = init_text(
    ...
    texts[2] = init_text("Avancer",
        ...
        text_size * SETTINGS->scaling, color);
    texts[3] = init_text("",
        (sfVector2f){ (810 * SETTINGS->scaling), (600 * SETTINGS->scaling)},
        text_size * SETTINGS->scaling, sfRed);
    texts[4] = NULL;
