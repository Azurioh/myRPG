...
void update_controls(myrpg_t *myrpg)
{
    ...
    GAME_INFO->keybinds->sprint = GAME_INFO->keybinds->keybind_edit[4];
    GAME_INFO->keybinds->open_inventory = GAME_INFO->keybinds->keybind_edit[5];
    GAME_INFO->keybinds->interact = GAME_INFO->keybinds->keybind_edit[6];
    GAME_INFO->keybinds->skills = GAME_INFO->keybinds->keybind_edit[7];
